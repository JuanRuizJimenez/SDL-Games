...
std::vector<std::string> Resources::imageFiles_ { "images/blank.png",
		...
		"images/star.png", "images/ship.png", "images/ship2.png", "images/ship3.png", 
		"images/ship4.png", "images/ship5.png", "images/ship6.png", "images/laser.png", 
		"images/background.png", "images/asteroid.png", "images/asteroidsHUD.png", "images/shoot.png",
		"images/life.png", "images/asteroidsHUD2.png", "images/victory.png", "images/loose.png", 
		"images/champ.png", "images/feather.png", "images/bomb.png", "images/thwomp.png", "images/bill.png",
		"images/up.png"};
...
std::vector<std::string> Resources::musicFiles_ { "sound/background.mp3" };

std::vector<std::string> Resources::soundEffectFiles_ { "sound/death.mp3", "sound/explosion.mp3", 
		"sound/over.mp3", "sound/shoot.mp3", "sound/start.mp3", };
